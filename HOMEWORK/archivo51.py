...
class FormularioArticulos:
    ...
    def listado_completo(self):
        ...
        self.scrolledtext1=st.ScrolledText(self.labelframe3, width=80, height=10)
    ...
    def borrado(self):
        ...
        self.cuaderno1.add(self.pagina4, text="Borrar artículos")
    ...
    def borrar(self):
        ...
        if cantidad==1:
            mb.showinfo("Información", "Se borró el articulo con dicho código")
        else:
    ...
    def modifica(self):
        ...
        if cantidad==1:
            mb.showinfo("Información", "Se modifico el articulo ")
        else:
            mb.showinfo("Información", "No existe un articulo con dicho código")
